...
export default function NotFound() {
  ...
  return (
    <>
      <Seo title={t('notFound.title')} description={t('notFound.desc')} path="/404" />
      <section className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6 py-20">
        <p className="overline text-gold mb-4">{t('notFound.overline')}</p>
        <h1 className="text-4xl md:text-6xl text-black mb-6">{t('notFound.title')}</h1>
